...
::: {.notes}
Technology has vastly improved since my student days, but I many evaluators are
still using manual workflows like that. They don't know what is possible now.
Were I to be asked to resume using those older tools and workflows, this quote
from Spock would be apt.
:::
