...
title-slide-attributes: 
  data-notes: My talk today focuses on some principles, practices, and tools 
              ...
              evaluation reports. My goal is promote encourage evaluators to 
              build their capacity and competency by adopting practices and 
              ...
              to do so, and accelerate your learning journey. My slides are in 
              an HTML file available from the link at the bottom of the screen. 
...
::: {.notes}
So, let’s set the stage with a definition. Reproducible research is research for 
...
broadly, I believe reproducbility is just as valuable in--and applicable
...
the same result from a new set of data. How confident are you about about where
your work falls on this spectrum?
:::
...
our ability to judge the their quality and provides a poor foundation for future 
replication studies.
...
::: {.notes}
There are plenty of signs that funders value RR. For example, NIH and NSF have
data sharing policies, so you must address data sharing in grant proposals. 
They’ve also launched reproducibility initiatives. NIH started by promoting
selected aspects of reproducibility for preclinical studies, but not expects it
in a wider range of studies. Other federal funders like NSF and IES have also
published materials promoting reproducibility.
:::
...
that sharing your data because nobody can recreate your findings without them.
The methods criterion requires that you share your methods in sufficient detail,
preferably through sharing the actual software code or scripts you used to get
the results. The documentation criterion requires that you share adequate
documentation of the data set, software environment, and software code so others
can understand what you had, what you did with it, and what it really means.
Finally, the distribution criterion requires that you use standard methods to
...
::: {.notes}
Let’s unpack the definition of reproducible research by giving some examples of
the kinds of materials & findings we are discussing. This is just a sample of
what could be encompassed by these two terms.
:::
...
::: {.notes}
Understanding a few guiding principles helps people figure out how to achieve
...
instances of these principles in action throughout the rest of this talk. My
examples will aim toward the middle of the complexity spectrum.
:::
...
documentation; and can even contain dynamic documents and rendered output. So,
Marwick and colleagues suggest using an R package as your research compendium! 
The conventional structure guides you to organize your files into specific 
subfolders and separate certain kinds of files--such as data versus code--from 
each other. It suggests specific kinds of documentation to include, like a
README file that introduces new users to your work.
:::
...
file a simple name that stays constant even while Git tracks how it changes 
over time. Jenny Bryan's paper on using proper version control persuaded me to 
start using Git. I have not regretted it! So, put your compendium into a Git 
repository! 
:::
...
## Collaboration {style="text-align: right" background-image="graphics/pexels-fauxels-3184634.jpg" background-position="top" }

:::: {.absolute left="55%" top="25%" style="padding: 0.25em .5em; background-color: rgba(255, 255, 255, .5); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 20px; text-align: left;"}
Plan to give files to multiple stakeholders:  
