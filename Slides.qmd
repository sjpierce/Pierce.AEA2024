...
* Use scripts instead of GUIs
    * Make them start from a clean R session
...
a clean R session--an empty workspace--and use code to load everything it needs 
to run. You also want to render each script in its entirely frequently as you 
develop it. That's the best way make sure the whole thing works correctly. 

I encourage you all to remember that computers are inhumanely patient. They're 
great at tedious, repetitive tasks that bore or fatigue humans into making 
errors. If something is mind-numbingly tedious, write code to get the computer 
to do it for you. However, computers are also literal-minded idiots. They do 
exactly what you tell them to do, whether or not that makes sense or is what you 
intended. Put your time into giving them the right instructions and checking 
that you got the right results. 
:::
...
of repository contents is a major bonus, but not strictly required. I reocmmend 
that your scripts include some component that automates recording infoirmation 
about the software environment and versions you used to meet the documentation 
...
* Are just plain text files with names ending in `.qmd`
...
* [Inline code](https://quarto.org/docs/computations/inline-code.html) lets you 
  insert dynamic text or numbers in the middle of sentences. 
* [Code chunks](https://quarto.org/docs/computations/r.html) allow you to do
  larger computations and inserting more complex results. 
...
* Rendered output
    * scripts/output/Create_MyStudy_Data.html
