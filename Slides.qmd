...
result from a new set of data. How confident about where your work falls on this 
spectrum? 
:::
...
::: {.notes}
Let’s start with the fact that methods matter. How we conduct research
influences where our studies fall along a continuum of trustworthiness and
scientific credibility. Studies that use good scientific practices have higher
trustworthiness and credibility. Where do different types of research fall along
this continuum?
...
(Peng et al., 2006). So, let’s look at some specific forces I see pushing us
toward RR.
:::

## Guiding Principles for Evaluators

Pursuing reproducibility enacts several of our guiding principles 
[@AEA-RN8648]: 
...
::: {.notes}
I also want to emphasize that prusing reproducibility is a good way to enact 
several of AEA's guiding principles for evaluators, namely systematic inquiry, 
...
::: {.notes}
First, we’re starting to see stronger signs that funders value RR. For example,
NIH and NSF have data sharing policies, so you ought be to addressing data
sharing in your grant proposals. They’ve also started talking about
reproducibility. NIH’s rigor & reproducibility initiative currently aims to
promote selected aspects of RR for preclinical studies. I don’t think it’s going
to be long before NIH expands its focus to more aspects of reproducibility and a
...
::: {.notes}
There are emerging scientific norms in favor of RR. These are evident in things
like the CONSORT reporting guidelines, calls for pre registered methods/trials,
calls to publish raw data, and RR policies being adopted by various journals.
They are also reflected in local institutional policies.
:::
...
::: {.notes}
Modern publishing technology makes RR more feasible. Previously, we relied
mostly on printed journals to distribute scientific papers, so cost and page
limits restricted the ability to do RR. Now, online publishing means you can
easily publish supplemental files alongside your papers, or deposit data,
...
eliminates page limits, and increases opportunity to meet RR standards.
:::

## Career Benefits of RR

* Motivation to be more careful
* Easier to get published
* ... in better journals
* Get cited more often
* Reproducibility materials are additional scholarly products

::: {.notes}
I think there are probably some real career benefits of RR. For example, it may
motivate people to be more careful about avoiding errors, thereby increasing the
quality of their work. It may be easier to get published, you might be able to
publish in better journals, and you might ultimately get cited more often as
people either adopt your methods, use your data for new studies, or discuss your
work as an exemplar of high quality science.
:::
...
::: {.notes}
Reproducibility is really a continuum, but there are some simple criteria that
we can use to evaluate how reproducible a given project is. The data criterion
requires that you share the data you used, since nobody can recreate your
findings without them. The methods criterion requires that you share your
methods in sufficient detail, preferably through sharing the actual software
code or scripts you used to get the results. The documentation criterion
requires that you share adequate documentation of the data set, software
environment, and software code so others can understand what you had, what you
did with it, and what it really means. Finally, the distribution criterion
requires that you use standard methods to distribute all these materials.
:::
