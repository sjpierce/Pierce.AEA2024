...
```
MyProject/          [Compendium, Git repository, R package, RStudio project]
...
::: {.notes}
Suppose I've got a project creatively named MyProject. Here's what its folder
structure might look like. The MyProject folder is a research compendium that is
