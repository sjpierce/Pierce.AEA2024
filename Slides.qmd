...
title-slide-attributes: 
  data-notes: 1 hr (45-50 min talk + 10-15 min Q & A) My name is Steven Pierce. 
              ...
              right in and are themselves a reproducible product. I encourage 
              you to download and study them in detail later. 
...
the same result from a new set of data. Think about where your work falls on 
this spectrum. 
:::
...
codebooks and other documentation; analysis scripts; and even raw output in data 
archives/repositories. This vastly reduces cost, eliminates page limits, and 
increases opportunity to meet reproducibility standards.
:::
...
report by re-rendering the script, or fix an error in either the data or the 
script then render again to automate updating the report.
:::
...
attention to applying the principles I listed earlier.
:::
...
you to collaborate with teammates to develop a report. Later, you can make the
...
strictly required. Use code in a script to automate recording information about 
the software environment to meet the documentation criterion for 
reproducibility.
:::
