...
::: {.notes}
There are emerging scientific norms aligned with RR. These are evident in things
...
::: {.notes}
Modern publishing technology makes RR more feasible. When we we relied mostly on
...
and analysis. We updated data files interactively. We created tons of files,
saving to a new filename as chages accrued. That led to confusing proliferation
of folders and files with little planned structure. It was hard to tell who had
last edited various files and which versions to use. We eitehr retyped or pasted
results from SPSS output into Word documents then spent lots of time formatting
them further. If we made a mistake along the way, we had to spend hours and days 
re-doing things. Over time I learned some strategies to improve that workflow,
...
that the software tools weren't really integrated and they lacked key features
and support for better workflows. 

Technology has vastly improved since then, but many evaluators are still using 
these sorts of manual workflows and don't know what is possible now. 
:::
...
::: {.notes}
Today, I'm trying to show you a better way to do your analyses and write your
reports. It depends on taking advantage of better software and learning new
workflows. This is a list of free software packages that comprise an elegant,
powerful, and integrated set of tools for doing reproducible analyses and
reports. These are my favorite tools now, in part because they enable me to
...
with narrative text, headings, and in-text citations. When you compile those
...
formatted equations, in-text citations that automatically populate
fully-formatted reference sections, and more. This diagram shows the basic 
structure.
:::
...
* MyProject/
    ...
    * scripts/
        * output/
            * Import_Data_2024-08-31.pdf
            * Report_1_2024-08-31.pdf
        * _quarto.yml
        * Import_Data.qmd
        * Report_1.qmd
        * Render_Scripts.qmd
...
::: {.notes}
RStudio project + R package structure + Quarto project
