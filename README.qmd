...
audience. I assume most of my audience just wants copies of 
[my slides](https://github.com/sjpierce/Pierce.AEA2024/Slides.html), but
some may want to see exactly how they were created by examining other parts of 
the repository.

> **Tip:** After you open the 
> [Slides.html](https://github.com/sjpierce/Pierce.AEA2024/Slides.html) file, 
> press the `s` key on your keyboard to see the speaker view that contains my 
> speaker notes. There are also other 
