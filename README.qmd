...
> **Tip:** My slides are in a file called `Slides.html` stored on GitHub. To 
> download that file, click this 
...
> **Tip:** After you open the `Slides.html` file, press the `s` key on your
> keyboard to see the speaker view that contains my speaker notes. There are 
> also other 
