...
> **Download Tip:** My slides are in a file called `Slides.html` stored on 
> GitHub. To download that file, click this 
> [this link](https://github.com/sjpierce/Pierce.AEA2024/blob/main/Slides.html) 
> then go to the upper right corner of the screen and use the "Download raw 
> file" button that looks like an arrow pointing down into a tray. It is located 
> just to the left of the pencil icon. Once the file is on your computer, open 
> it with a web-browser. 

> **Usage Tip:** After you open the `Slides.html` file, press the `s` key on 
> your keyboard to see the speaker view that contains my speaker notes. There 
> are also other 
